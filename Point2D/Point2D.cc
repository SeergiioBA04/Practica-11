...
Point2D::Point2D(double vector_x, double vector_y) : vector_x_{vector_x}, vector_y_{vector_y} {
...
Point2D Point2D::Middle(Point2D punto) {
    double vector_x = (punto.vector_x_ + vector_x_) / 2;
    double vector_y = (punto.vector_y_ + vector_y_) / 2;
